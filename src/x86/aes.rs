...
pub unsafe fn _mm_aesdec_si128(a: __m128i, round_key: __m128i) -> __m128i {
    crate::mem::transmute(crate::myarch::_mm_aesdec_si128(crate::mem::transmute(a), crate::mem::transmute(round_key)))
}
...
pub unsafe fn _mm_aesdeclast_si128(a: __m128i, round_key: __m128i) -> __m128i {
    crate::mem::transmute(crate::myarch::_mm_aesdeclast_si128(crate::mem::transmute(a), crate::mem::transmute(round_key)))
}
...
pub unsafe fn _mm_aesenc_si128(a: __m128i, round_key: __m128i) -> __m128i {
    crate::mem::transmute(crate::myarch::_mm_aesenc_si128(crate::mem::transmute(a), crate::mem::transmute(round_key)))
}
...
pub unsafe fn _mm_aesenclast_si128(a: __m128i, round_key: __m128i) -> __m128i {
    crate::mem::transmute(crate::myarch::_mm_aesenclast_si128(crate::mem::transmute(a), crate::mem::transmute(round_key)))
}
...
pub unsafe fn _mm_aesimc_si128(a: __m128i) -> __m128i {
    crate::mem::transmute(crate::myarch::_mm_aesimc_si128(crate::mem::transmute(a)))
}
...
pub unsafe fn _mm_aeskeygenassist_si128(a: __m128i, imm8: i32) -> __m128i {
    ...
    macro_rules! call {
        ($imm8:expr) => {
            crate::myarch::_mm_aeskeygenassist_si128(crate::mem::transmute(a), $imm8)
        };
    }
